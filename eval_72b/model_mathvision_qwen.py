...
def eval_model(args):
    ...
    questions = list(load_dataset("MathLLMs/MathVision", split="testmini"))
    ...
    for chunk in tqdm(split_list(questions, math.ceil(len(questions) / batch_size))):
        ...
        for data in chunk:
            ...
            batch_inputs.append({"prompt": text, "multi_modal_data": {"image": data['decoded_image']}})
